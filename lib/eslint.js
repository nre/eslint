...
module.exports = (function() {
    ...
    api.verify = function(textOrSourceCode, config, filenameOrOptions, saveState) {
        ...
        if (ast) {
            ...
            /* FIXME: escope implied strict workaround
             */
            escopeImpliedStrictWorkaround = ecmaFeatures.impliedStrict;

            if (escopeImpliedStrictWorkaround) {
                useStrictStatement = parse("'use strict';").body[0];
                ast.body.unshift(useStrictStatement);
            }
